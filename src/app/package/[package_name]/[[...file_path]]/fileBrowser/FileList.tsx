...
export const FileList = ({
  ...
  return (
    <section className="mb-2 grid w-full grid-cols-3 gap-y-2 sm:grid-cols-7 md:grid-cols-6 lg:grid-cols-9 xl:grid-cols-12">
      <p className="col-span-1 mb-1 bg-zinc-700 pb-1 pr-2 text-end font-title">
        Type
      </p>
      <p className="col-span-2 mb-1 bg-zinc-700 pb-1 pl-2 font-title sm:col-span-6 md:col-span-5 lg:col-span-8 xl:col-span-11">
        File Name
      </p>
      {keys.map((fileName) => (
